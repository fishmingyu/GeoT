...
if __name__ == '__main__':
    ...
    # manually replace index_add_ and index_select 
    # with fused operation (geot.gather_scatter)
    ...
    assert torch.allclose(out_sage, out_compile, atol=1e-6)