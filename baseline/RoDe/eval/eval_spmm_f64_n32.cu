...
int main(int argc, char **argv) {
  ...
  //     c_sm.RowIndices(),
  //                      c_sm.Values(), c_sm.RowOffsets(),
  //                      c_sm.ColumnIndices(), d_B.Values(), d_C1, stream1);
  ...
  cu_sp.Preprocess(m, c_sm.Columns(), c_sm.Nonzeros(), c_sm.RowOffsets(),
                   c_sm.ColumnIndices(), c_sm.Values());
  ...
  for (int i = 0; i < ITER; ++i)
    RoDeSpmm_n32(c_sm.n_segs, c_sm.n_segs_residue, c_sm.Columns(), n,
                 ...
                 c_sm.seg_row_indices, c_sm.seg_row_indices_residue,
                 c_sm.seg_st_offsets, d_B.Values(), d_C2, stream1, stream2);
