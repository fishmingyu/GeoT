...
row_pointers, column_index, degrees, t_window_rowTensor,t_atomicTensor=FS_Block.blockProcess_fp16_balance(row, col, dd, 8, 8, 1)
...
rhs = torch.randint(low=1, high=2, size=(30, dimN))
rhs = rhs.half()

result, spmm_ms_avg =  FS_SpMM.forward_fp16_balance(   
                        row_pointers, 
                        column_index, 
                        degrees, 
                        t_window_rowTensor,
